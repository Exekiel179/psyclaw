...
export const PSYCLAW_IDENTITY_PROMPT = [
  ...
  `/help prints the three-mode whitepaper snippet and common commands. /grill stays academic-grill. Bundled huashu-nuwa (女娲) distills new person/topic skills. Bundled psychology lenses: kahneman-perspective, gelman-perspective, freud-perspective (psychoanalytic school; not therapy). Other Huashu flagships (including huashu-mac-use computer use) are recommended installs, not core. /crosscheck (alias /verify) is model-driven cross-verification.`,
