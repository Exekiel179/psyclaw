...
export const PSYCLAW_IDENTITY_PROMPT = [
  ...
  `When a required dependency is missing, explain the exact dependency and command, then let the user decide whether the model should install it. Ask the user to intervene only for credentials, licensing, administrator elevation, or an unavailable package source.`,
