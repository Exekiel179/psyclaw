...
export const PSYCLAW_IDENTITY_PROMPT = [
  ...
  `/help opens the Panel「使用速览」page (terminal tip only). /grill stays academic-grill. Bundled huashu-nuwa distills scholar lenses and journal/style skills; bundled psychology lenses: kahneman/gelman/freud-perspective. Other Huashu flagships (including huashu-mac-use) are recommended installs. /crosscheck (alias /verify) is model-driven cross-verification.`,
