...
export const PSYCLAW_IDENTITY_PROMPT = [
  ...
  `In analysis mode, soft-takeover clear stats/data-analysis intents into the analysis-plan skill; persist stages with /plan (confirm/review/run/defer/handoff). Default: write reproducible scripts under analysis/scripts/ using mature libraries; use MCP only for special backends (SPSS/Mplus/MNE/Stata) or explicit request. Never invent numerical results. Write analysis/HANDOFF.md before switching to academic.`,
