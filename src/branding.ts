...
export const PSYCLAW_IDENTITY_PROMPT = [
  ...
  `/help opens the Panel「使用速览」page (terminal tip only). /grill stays academic-grill. Scholar/journal distillation is recommended install distill-scholar / distill-journal (https://github.com/Exekiel179/distill-skills), not bundled nuwa. Bundled psychology lenses: kahneman/gelman/freud-perspective. Other Huashu flagships remain recommended. /crosscheck (alias /verify) is model-driven cross-verification.`,
