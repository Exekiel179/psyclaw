...
const templates: readonly { path: string; label: string; contents: (goal: string) => string }[] = [
  ...
  { path: "notes/decisions.md", label: "Research Decisions", contents: () => `${header("psyclaw/research-decisions/v1", "Research Decisions")}- Status: awaiting-grill\n\n| Decision | Rationale | Alternatives considered | Owner | Status |\n| --- | --- | --- | --- | --- |\n| Research specification | Pending academic grill | - | researcher | pending |\n` },
