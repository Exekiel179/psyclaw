...
export function sessionModePrompt(mode: PsyClawSessionMode): string {
  ...
  if (mode === "analysis") {
    return [
      ...
      "Write under data/clean, analysis/scripts|configs|results, and analysis/HANDOFF.md. Never overwrite data/raw (or legacy .psyclaw/data/raw).",
      "Delegate real statistics to external MCP/libraries; do not invent numerical results.",
