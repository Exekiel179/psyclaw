...
export function formatCliUsage(): string {
  ...
  return [
    ...
    cmd("/agents", "[list|set|use|clear|…]", c.white("管理人设提示词（研究角色设定）")),
    ...
    `  ${c.gray("终端：")} ${c.teal("psyclaw --developer")} ${c.darkGray("/")} ${c.teal("psyclaw -D")} ${c.gray("启用开发者命令（/verify、/model、/agents run）")}`,
