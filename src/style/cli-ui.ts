...
export function formatCliUsage(): string {
  ...
  return [
    ...
    cmd("/approve", "", c.white("审批 /init 生成的主要计划文档")),
    cmd("/run", "[auto] [--skills a,b] [objective]", c.white("启动人在环路或自动研究流程")),
